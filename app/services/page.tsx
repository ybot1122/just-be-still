      ...
      <PageSection>
        <ServiceItem q="Sewing Classes">
          ...
          <ServiceItemParagraph>
            ...
            generation of designers. Sign up today and let the creativity begin!
          </ServiceItemParagraph>
          <ServiceItemParagraph>
            <Link
        ...
        <ServiceItem q="Alterations">
          <ServiceItemParagraph>
            ...
            for your waist, and you&apos;ve been relying on a safety pin to make
            it work? It&apos;s time to alter them to your size! Alterations are
        ...
        <ServiceItem q="Custom Order">
          <ServiceItemParagraph>
            ...
            special needs. Plush blankets are made with your child&apos;s
            favorite plush; fleece blankets can be made from your child&apos;s
            favorite print. Have a baby shower to attend? We can make something
            special for you. Have a parent living with Alzheimer&apos;s or
        ...
        <ServiceItem q="Sewing Parties">
          <ServiceItemParagraph>
            ...
            length is 2 hours with a maximum of 12 kids. We&apos;ll consider
            themes and project choices. Everything will be provided.
          </ServiceItemParagraph>
        </ServiceItem>
