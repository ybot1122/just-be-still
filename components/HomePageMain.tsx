  ...
  return (
    <main>
      <div className="snap-y snap-mandatory">
        <HomePageHeroImageSection src={home_bg} alt="JustBeStill" index={0}>
        ...
        <HomePageInfoSection header="Welcome to JustBeStill" index={1}>
        ...
        <HomePageInfoSection isForest header={"Meet the Instructor"} index={3}>
          <div className="w-full px-5">
        ...
        <HomePageInfoSection header="Our Services" index={4}>
          ...
          <div className="text-2xl max-w-[1024px] md:leading-loose inline-block self-end text-white p-5 mb-10 md:grid md:grid-cols-2">
            <Link
              href="/services"
              className="underline bg-forest p-5 mx-5 mb-5 md:mb-0 inline-block"
            >
              See All our Services
            </Link>
            <Link
              href="/contact"
              className="underline mx-5 bg-forest p-5 inline-block"
            >
              Contact Us
            </Link>
          </div>
